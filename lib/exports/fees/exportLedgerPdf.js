...
export const generateLedgerPDF = ({ branchInfo, schoolInfo, transactions, filters, summary }) => {
    ...
    const headerH = 22;
    doc.setFillColor(17, 24, 39); // Deep dark gray/black
    ...
    const fileName = `Ledger_Report_${filters.startDate}.pdf`;

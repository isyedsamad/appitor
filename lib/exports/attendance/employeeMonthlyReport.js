...
export function exportEmployeeMonthlyPDF({ branchInfo, month, employees, daysInMonth, monthRecords }) {
  ...
  doc.text(`MONTHLY EMPLOYEE ATTENDANCE REPORT`, centerX, currentY + 13, { align: 'center' });
  doc.text(`Analysis Period: ${month}`, centerX, currentY + 17, { align: 'center' });

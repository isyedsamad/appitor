...
export function exportStudentMonthlyPDF({ branchInfo, schoolName, className, section, month, students, days, monthRecords }) {
  ...
  doc.setFontSize(8);
  doc.text(`MONTHLY STUDENT ATTENDANCE REPORT - ${month} | Class: ${className} | Section: ${section}`, centerX, currentY + 23, { align: 'center' });
  ...
  autoTable(doc, {
    ...
    headStyles: { fillColor: [15, 23, 42], fontSize: 6 },
    columnStyles: {

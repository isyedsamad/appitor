...
export const exportStudentDailyPDF = ({ branchInfo, schoolName, className, section, date, students, dateRecords, stats }) => {
    ...
    doc.setFontSize(8);
    doc.text(`DAILY STUDENT ATTENDANCE REPORT | Date: ${date} | Class: ${className} | Section: ${section}`, centerX, currentY + 23, { align: 'center' });

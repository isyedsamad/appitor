...
export const exportEmployeeDailyPDF = ({ branchInfo, date, employees, dayRecords, stats }) => {
    ...
    doc.text(`DAILY EMPLOYEE ATTENDANCE REPORT`, centerX, currentY + 18, { align: 'center' });

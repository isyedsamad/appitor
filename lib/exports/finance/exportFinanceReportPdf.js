...
export const generateFinanceReportPDF = ({ branchInfo, schoolName, summary, trend, mode, label }) => {
    ...
    doc.setFontSize(8);
    doc.setFont("helvetica", "normal");
    doc.text(`${mode.toUpperCase()} ANALYTICS | Period: ${label}`, centerX, currentY + 23, { align: 'center' });
    ...
    const stats = [
        ...
        { label: "NET REVENUE", value: summary.net, color: [15, 23, 42], bg: [249, 250, 251], border: [229, 231, 235] },

...
export async function POST(req) {
  ...
  try {
    ...
    const { admissionId, name, gender, mobile, dob, className, section, branch, branchNames, currentSession, branchCode, autoRoll, templateId, templateName } = await req.json();
